...
def save_creds(aws_access_key_id: str, aws_secret_access_key: str) -> None:
    """Save credentials to local file system."""

    # Format into JSON
    creds_obj = {"AWS_ACCESS_KEY_ID": aws_access_key_id, "AWS_SECRET_ACCESS_KEY": aws_secret_access_key}
...
def load_creds() -> Tuple[str, str]:
    ...
    aws_secret_access_key = creds_obj["AWS_SECRET_ACCESS_KEY"]
...
def valid_creds() -> bool:
    ...
    valid = access_key_id and secret_access_key
